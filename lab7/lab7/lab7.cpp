...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_PAINT:
        ...
        DeleteObject(hPen);
        // первый кустик справа
        {
            hPen = CreatePen(PS_DASH, 2, RGB(144, 28, 220));
            SelectObject(hdc, hPen);
            int x1 = 400, y1 = 150; //первая точка - кончик ветки куста

            int x2 = 500, y2 = 250; // вторая точка - корень куста
            do {
        ...
        //второй кустик слева
        {
            hPen = CreatePen(PS_DASH, 2, RGB(89, 144, 27));
            SelectObject(hdc, hPen);
        ...
        //забор
        {
            hPen = CreatePen(PS_DASH, 2, RGB(243, 18, 18));
            SelectObject(hdc, hPen);
            int x1 = 150, y1 = 0;
            int x2 = 150, y2 = 100;
            do {
        ...
        //трава
        {
            hPen = CreatePen(PS_DASH, 2, RGB(35, 232, 41));
            SelectObject(hdc, hPen);
            int x1 = 100, y1 = 550;
            int x2 = 75, y2 = 580;
            do {
